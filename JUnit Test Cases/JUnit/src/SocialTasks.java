...
public class SocialTasks {

	public HashMap<String,String> createSocialAccount(String firstname, String lastname, String email,
	...
	public HashMap<String,String> socialLogin(String socialProviderEmail, String password)
	{
